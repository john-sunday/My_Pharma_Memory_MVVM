 ...
 * Use the [SearcherMyPharmaFragment.newInstance] factory method to
...
class SearcherMyPharmaFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SearcherMyPharmaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearcherMyPharmaFragment().apply {
