 ...
 * Use the [InfoMyListPharmaFragment.newInstance] factory method to
...
class InfoMyListPharmaFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InfoMyListPharmaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InfoMyListPharmaFragment().apply {
