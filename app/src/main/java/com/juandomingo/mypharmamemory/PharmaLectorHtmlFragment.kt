 ...
 * Use the [PharmaLectorHtmlFragment.newInstance] factory method to
...
class PharmaLectorHtmlFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PharmaLectorHtmlFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PharmaLectorHtmlFragment().apply {
